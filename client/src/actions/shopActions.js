...
export const getSize = data => async dispatch => {
  try {
    ...
    const res = await axios.get(`/api/size-assistant`, body, config);
    dispatch({
      type: GET_SIZE,
      payload: res.data,
    });
...
export const getLikedItems = () => async dispatch => {
  try {
    const res = await axios.get(`/api/users/buyer/wishlist`);
    dispatch({
...
export const getcartItems = () => async dispatch => {
  try {
    const res = await axios.get(`/api/users/buyer/cart`);
    dispatch({
      type: GET_CART_ITEMS,
      payload: res.data,
    });
...
export const likeItem = (data, itemId) => async dispatch => {
  ...
  try {
    const res = await axios.put(`/api/items/like/${itemId}`, body, config);
    dispatch({
      type: LIKE_ITEM,
      payload: res.data,
    });
...
export const unlikeItem = (item, size) => async dispatch => {
  try {
    const res = await axios.put(`/api/items/unlike/${item}/${size}`);
    dispatch({
      type: UNLIKE_ITEM,
      payload: res.data,
    });
...
export const like2cart = (item, size) => async dispatch => {
  try {
    const res = await axios.put(`/api/items/wishlist/cart/${item}/${size}`);
...
export const cartItem = (data, itemId) => async dispatch => {
  ...
  try {
    const res = await axios.put(`/api/items/cart/${itemId}`, body, config);
    dispatch({
      type: CART_ITEM,
      payload: res.data,
    });
...
export const uncartItem = (item, size) => async dispatch => {
  try {
    const res = await axios.put(`/api/items/uncart/${item}/${size}`);
    dispatch({
      type: UNCART_ITEM,
      payload: res.data,
    });
...
export const cartIncreaseOne = (item, size) => async dispatch => {
  try {
    const res = await axios.put(`/api/items/cart/plus/${item}/${size}`);
    dispatch({
...
export const cartDecreaseOne = (item, size) => async dispatch => {
  try {
    const res = await axios.put(`/api/items/cart/minus/${item}/${size}`);
    dispatch({
...
export const postItems = itemData => async dispatch => {
  try {
    ...
    const res = await axios.post(`/api/users/seller/item`, itemData, config);
