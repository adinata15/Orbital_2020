...
export const CHOOSE_LISTING = 'CHOOSE_LISTING';

//SHOP LIST
export const MENU = 'MENU';
export const GET_SIZE_RECOMMENDATION = 'GET_SIZE_RECOMMENDATION';
export const GET_SIZE_RECOMMENDATION_ITEM = 'GET_SIZE_RECOMMENDATION_ITEM';
export const FAIL_SIZE_RECOMMENDATION = 'FAIL_SIZE_RECOMMENDATION';
