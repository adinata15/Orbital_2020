...
export const uploadProfilePic = (pictureData) => async (dispatch) => {
	try {
		...
		dispatch(setAlert("Edit profile fail", "danger"));
		dispatch({
			type: EDIT_PROFILE_FAIL,
		});
	}
...
export const setAddress = (address) => async (dispatch) => {
	try {
		...
		dispatch(setAlert("Edit address fail", "danger"));
		dispatch({
			type: EDIT_PROFILE_FAIL,
		});
	}
...
export const deleteAddress = (address_id) => async (dispatch) => {
	try {
		...
		dispatch(setAlert("Delete address fail", "danger"));
		dispatch({
			type: EDIT_PROFILE_FAIL,
		});
	}
...
export const deleteListing = (item_id) => async (dispatch) => {
	try {
		...
		dispatch(setAlert("Delete item fail", "danger"));
